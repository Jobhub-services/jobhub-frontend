    ...
    render(){
        ...
        return(
            <StyledFlexBox justify='flex-start' align='flex-start'  height='100%'>
                <StyledDiv>
                    <StepProgress style={{marginLeft:'40px'}} direction="vertical" items={[{ name: 'Basics', valid:currentStep!-1===0,active: currentStep===0 }, { name: 'Details', valid: currentStep!-1===1,active:currentStep===1 },{ name: 'Qualifications',valid:currentStep!-1===2 ,active: currentStep===2 }, { name: 'Review',valid:currentStep!-1===3,active:currentStep===3 }]} />
                </StyledDiv>
                <SContainer>     
