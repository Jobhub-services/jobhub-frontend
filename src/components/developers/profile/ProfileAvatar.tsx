import { CameraIcon, LocationIcon, LocationSolidIcon } from '@/assets/icons';
	...
	return (
		<FlexBox gap={20} justify="start">
			...
			<div>
				...
				<FlexBox justify="start" gap={5} className="mt-5">
					<LocationSolidIcon color={colors.BLACK_9} width="18px" height="18px" />
					<FlexBox gap={10}>
						<SSapn>
