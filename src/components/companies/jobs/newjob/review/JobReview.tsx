            ...
            <FlexBox  justify='flex-start' align='flex-start'>
                <div style={{paddingRight:'15px',width:'250px'}}>
                    <div style={{marginTop:'20px'}}>
                        <Headline variant='h2' size="sm">Job role</Headline>
                        <div>
                ...
                <div style={{width:'800px',paddingLeft:'15px',borderLeft:`1px solid ${Colors.BLACK_12}`}}>
                    <Headline variant='h2' size="lg">Frontend developer</Headline>
                    <div>
                    ...
                    <div>
                        ...
                        <p style={{marginLeft:'20px',marginTop:'0'}}>
                            ...
                            2- Continuously review, improve and adjust all aspects of the user experience<br/>
                            3- Promote a culture of collaboration, care and high quality<br/>
                            4- Regularly conduct peer reviews, code audits and promote good practices<br/>
                            5- Work with other teams to build a technical ecosystem that enables high velocity, low-waste development<br/>
                        </p>
                    </div>
                    <CompensationReview />
