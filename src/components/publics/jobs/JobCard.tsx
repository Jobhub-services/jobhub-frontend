...
import JobAvatar from '@/components/publics/jobs/JobAvatar';
import { ApplicationFilledIcon, ClockIcon, LocationIcon, MoneyIcon, StarIcon } from '@/assets/icons';
		...
		<SContainer hover>
					...
					<div style={{ width: '63%' }}>
						...
						<FlexBox gap={5} justify="flex-start" className="mt-15">
							...
							<SSpan>
								...
								{props.currency?.code} {props.salary_type ? `/${props.salary_type}` : ''}
							</SSpan>
						</FlexBox>
					</div>
					<div style={{ width: '37%' }}>
			...
			<SFooter justify="space-between">
				...
				<FlexBox gap={10}>
					<Button
						size="sm"
						startIcon={<ApplicationFilledIcon />}
						variant="light"
						onClick={() => {
							navigate('/login');
						}}
